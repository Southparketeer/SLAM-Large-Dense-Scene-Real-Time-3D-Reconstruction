...
inline aiVector3D* MakeAssimpVertices(loo::Image<float4, loo::TargetHost> vbo)
{
...
inline aiColor4D* MakeAssimVerticesColor(loo::Image<unsigned char, loo::TargetHost> cbo)
{
...
inline aiMesh* MakeAssimpMeshFromVbo(loo::Image<float4, loo::TargetHost> vbo)
{
...
inline aiMesh* MakeAssimpMeshFromVboCbo(loo::Image<float4, loo::TargetHost> vbo, loo::Image<unsigned char, loo::TargetHost> img)
{
    aiMesh* mesh = new aiMesh();
    mesh->mPrimitiveTypes = aiPrimitiveType_POLYGON;
